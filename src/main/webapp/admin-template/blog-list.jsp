            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Dạng lưới</li>
                    </ul>
                    ...
                    <div class="card">
                        <div class="blogitem mb-5">
                            <div class="blogitem-image">
                                <a href="blog-details.jsp"><img src="<%=blog.getImg()%>" style="height: 450px" alt="blog image"></a>
                            ...
                            <div class="blogitem-content">
                                <div class="blogitem-header">
                                    <div class="blogitem-meta">
                                        <span><i class="zmdi zmdi-account"></i>Từ <a href="javascript:void(0);">Michael</a></span>
                                    </div>
                                ...
                                <h5><a href="<%=blog.getLinkBlog()%>"><%=blog.getTopic()%></a></h5>
