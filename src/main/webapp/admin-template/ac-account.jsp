                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card">
                        <div class="body product_item">
                            <img src="<%=account.getImg()%>" alt="Product" class="img-fluid cp_img" style="min-height: 220px; min-width: 219px"/>
                            <div class="product_details">
                                <a href="ec-product-add.jsp"><%=account.getFullName()%>
                                </a>
                                <ul class="product_price list-unstyled">
                                    <li class="old_price"><%=account.getEmail()%>đ</li>
                                    <!-- <li class="new_price">$45.00</li> -->
                                </ul>
                            </div>
                            <div class="action">
                                <a href="javascript:void(0);" class="btn btn-info waves-effect"><i
