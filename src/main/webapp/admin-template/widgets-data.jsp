...
<script src="admin-template/assets/bundles/countTo.bundle.js"></script>
<script src="admin-template/assets/bundles/knob.bundle.js"></script>
...
<script src="admin-template/assets/js/pages/widgets/infobox/infobox-1.js"></script>
