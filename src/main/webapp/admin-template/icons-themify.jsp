        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Mũi tên</strong> &amp; Biểu tượng hướng</h2>
                        </div>
                        <div class="body">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong>Web</strong> biểu tượng ứng dụng</h2>
                        </div>
                        <div class="body">
                            <div class="icon-section">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong>Biểu tượng</strong> điệu khiển</h2>
                        </div>
                        <div class="body">
                            <div class="icon-section">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong>Biểu tượng</strong> văn bản</h2>
                        </div>
                        <div class="body">
                            <div class="icon-section">                    
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong>Biểu tượng</strong> bố trí</h2>
                        </div>
                        <div class="body">
                            <div class="icon-section">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong>Biểu tượng</strong> thương hiệu</h2>
                        </div>
                        <div class="body">
                            <div class="icon-section">                    
