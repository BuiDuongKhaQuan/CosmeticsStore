                ...
                <div class="shopping__cart__table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="cart__price" style="    width: 340px;"></td>
...
<%--                                </div>--%>
                            ...
                            <td class="cart__price__total"></td>
...
<%--                                <i class="fa fa-close" style="margin-left: 10px"></i>--%>
                    ...
                    <div>
                        <h3 style="margin-top: 20px;color: #3d3d3d">Bạn hãy đăng nhập để thêm sản phẩm vào giỏ hàng</h3>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="cart__total">
                    <h6>Tổng đơn hàng</h6>
                    <ul>
                        <li>Đơn giá <span>0đ</span></li>
                        <li>Tổng cộng <span>0đ</span></li>
                    </ul>
