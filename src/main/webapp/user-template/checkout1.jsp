...
<section class="checkout spad">
    <div class="container">
        <button type="submit" class="site-btn" STYLE="MARGIN-BOTTOM: 45PX;">GIỎ HÀNG BẠN KHÔNG CÓ SẢN PHẨM</button>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="checkout__input">
                            ...
                            <input type="text"
                                   placeholder="Hãy ghi chú về đơn hàng của bạn cho chúng tôi biêt.">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="checkout__order">
                            ...
                            <ul class="checkout__total__all">
                                ...
                                <li>Tổng thanh toán <span>0đ</span></li>
                            </ul>
