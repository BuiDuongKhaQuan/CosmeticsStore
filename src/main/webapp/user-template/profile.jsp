                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <%--                            session1.setAttribute("idA1", acc1.getIdA());--%>
                                    <%--                        %>--%>

                                    <div class="d-flex flex-column align-items-center text-center">
                                        <form action="FileUploadServlet" method="post"
                                              enctype="multipart/form-data">
                                            <img src="D:\apache-tomcat-9.0.69\webapps\ShopMyPham_war\uploads\p.jpg"
                                                 width="200px">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="profile" method="post">
                                        ...
                                        <input name="idAccount" type="hidden" class="form-control" value="<%=acc1.getIdA()%>">
                                        <div class="row">
                                            <div class="col-sm-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input name="email" type="text" class="form-control" value="<%=acc1.getEmail()%>">
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input name="phone" type="text" class="form-control" value="<%=acc1.getPhone()%>">
                                            </div>
                                        </div>
                                        <hr/>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <a href="changePass?idA=<%=acc1.getIdA()%>" class="col-sm-9 text-secondary">Đổi
                                                    mật
                                                    khẩu</a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body p-4">
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    ...
                                                    <p class="small text-muted mb-0">
                                                        <a href="detailOrder?idCk=<%=checkOut.getIdCk()%>">Mã đơn : #<%=checkOut.getIdCk()%></a>
                                                    </p>
                                                </div>
                                                <%
                                    ...
                                    <div class="col-lg-10 col-xl-80">
                                        <div class="card" style="border-radius: 10px;">
                                            ...
                                            <div class="card-footer border-0 px-4 py-5"
                                                ...
                                                <h5 class="d-flex align-items-center justify-content-end text-white text-uppercase mb-0">
                                                    Tổng giá trị đơn hàng: <span
                                                        class="h2 mb-0 ms-2"> <%=nf.format(total2 + 25000)%>đ</span></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
