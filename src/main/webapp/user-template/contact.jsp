                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__text">
                        <div class="section-title">
                            ...
                            <p>Nếu có thắc mắc vấn đề nào đừng ngần ngại àm liên hệ ngay cho chúng tôi. Chúng tôi sẽ cố gắng giải đáp các câu hỏi 1 cách chính xác và nhanh nhất.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="contact__form">
                        ...
                        <form action="contact" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <textarea  type="text" name="content" placeholder="Nôi dung"></textarea>
