        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <nav class="header__menu mobile-menu">
                    ...
                    <ul>
                        ...
                        <li class="<%=activeProduct%>"><a href="./product">Sản phẩm</a></li>
                        <li class="<%=activePage%>"><a href="#">Trang</a>
                            <ul class="dropdown">
                                ...
                                <%} else {%>
                                <li><a href="./shopping-cart1.jsp"> Giỏ hàng</a></li>
                                <li><a href="./checkout1.jsp">Thanh toán</a></li>
                                <%}%>
                            </ul>
                        </li>
            ...
            <div class="col-lg-3 col-md-3">
                <div class="header__nav__option">
                    ...
                    %>
                    <a href="cart-show"><i class="fa fa-shopping-cart" aria-hidden="true"
